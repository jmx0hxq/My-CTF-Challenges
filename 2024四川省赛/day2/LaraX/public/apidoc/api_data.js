define({ "api": [
  {
    ...
    "examples": [
      {
        "title": "curl示例:",
        "content": "curl -d \"id=15097995384666600001356001\" http://api.AI.com/v2/decode/result?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9",
        "type": "curl"
      }
    ],
    "success": {
    ...
    "sampleRequest": [
      {
        "url": "http://api.AI.com/v2/decode/result?token=:token"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://api.AI.com/v2/report?token=:token"
      }
    ]
  },
  {
    ...
    "examples": [
      {
        "title": "curl示例:",
        "content": "curl http://api.AI.com/v2/servers",
        "type": "curl"
      }
    ],
    "success": {
    ...
    "sampleRequest": [
      {
        "url": "http://api.AI.com/v2/servers"
      }
    ]
  },
  {
    ...
    "examples": [
      {
        "title": "curl示例:",
        "content": "curl \"type_id=100001&file=data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAMAAAARCA0dGVyY4LQCQAAABFXKwAAAABJRU5ErkJggg==\"\nhttp://api.AI.com/v2/decode/upload-base64?token=eyJ0eXAiOiJKV1QizI1NiJ9.eyJpc3MiOiJodHRwOi8NhcH4NzJkzAifQ.vwdP3rEVSnmbEoKTwAegcg0BaZ0sIQ",
        "type": "curl"
      }
    ],
    "success": {
    ...
    "sampleRequest": [
      {
        "url": "http://api.AI.com/v2/decode/upload-base64?token=:token"
      }
    ]
  },
  {
    ...
    "examples": [
      {
        "title": "curl示例:",
        "content": "curl -F \"file=@captcha.jpg\" -F \"type_id=10001\" http://api.AI.com/v2/decode/upload?api_token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9",
        "type": "curl"
      }
    ],
    "success": {
    ...
    "sampleRequest": [
      {
        "url": "http://api.AI.com/v2/decode/upload?token=:token"
      }
    ]
  },
  {
    ...
    "examples": [
      {
        "title": "curl示例:",
        "content": "curl -i http://api.AI.com/v2/user/point?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6MTk4NjkxOCwiZXhwIjoxNTEwNzYxNzE0fQ.v79tOJ5Ji_O4pqB03JBzFs-J2W3LLABYEw0MpCY1LCk",
        "type": "curl"
      }
    ],
    "success": {
    ...
    "sampleRequest": [
      {
        "url": "http://api.AI.com/v2/user/point?token=:token"
      }
    ]
  },
  {
    ...
    "examples": [
      {
        "title": "curl示例",
        "content": "curl -d \"email=admin@example.com&password=123456\" http://api.AI.com/v2/user/login",
        "type": "curl"
      }
    ],
    "success": {
    ...
    "sampleRequest": [
      {
        "url": "http://api.AI.com/v2/user/login"
      }
    ]
  }
] });
